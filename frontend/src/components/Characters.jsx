...
const characters = [
  ...
  },
  {
    ...
    age: '16',
    ethnicity: 'Hispanic',
    description: 'Intuitive and empathetic with a gift for seeing beyond the veil. Can reveal hidden glyphs and read ritual inscriptions. Her Echo Shift ability unveils secrets lost to time.',
    abilities: [
      'Echo Shift ability',
      'Reveal hidden objects',
      'Read ancient inscriptions',
      'Sense spiritual presence',
    ],
    quote: '"The past is calling. We need to listen."',
  },
  {
    name: 'Alex Chen',
    role: 'Tech / Scan',
