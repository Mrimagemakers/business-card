...
const characterData = {
  ...
  rosa: {
    ...
    look: 'Wavy dark brown hair, denim jacket, white tee, red flannel tied at waist',
    personality: 'Intuitive, empathetic, spiritually attuned',
    voiceTone: 'Soft, thoughtful, reassuring',
